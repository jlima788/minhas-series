...
const InfoSerie = ({match}) => {
  ...
  const save = () => {
    axios
      .put("/api/series/"+ match.params.id, {...form, genre_id: genreId})
      .then(res => {
        setSuccess(true);
      });
  };
            ...
            <div className="row h-100 align-items-center">
              ...
              <div className="col-8">
                ...
                <div className="lead text-white">
                  {data.status === 'ASSISTIR' && <Badge color="success">Assistido</Badge> }
      ...
      </div>
      {
        ...
        <div className="container">
            ...
            <div className="form-check">
                <input className="form-check-input" type="radio" checked={form.status === 'ASSISTIDO'} name="status" id="assitido" value="ASSISTIDO" onChange={seleciona('ASSISTIDO')} />
